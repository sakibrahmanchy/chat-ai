...
export function DashboardPreview() {
  ...
  return (
    <div className="rounded-xl border bg-white overflow-hidden max-w-[1400px] mx-auto backdrop-blur-sm backdrop-saturate-150">
      {/* Enhanced Header */}
      <div className="border-b bg-gradient-to-r from-slate-50 to-white p-3 sm:p-4">
      ...
      <div className="grid lg:grid-cols-12 divide-y lg:divide-y-0 lg:divide-x divide-slate-200">
        {/* Main Content */}
        <div className="lg:col-span-8 p-3 sm:p-4 md:p-6">
          {/* Stats Grid */}
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-3 md:gap-4 mb-4 sm:mb-6 md:mb-8">
            {[
              {
        ...
        {/* Analysis Panel */}
        <div className="lg:col-span-4 p-3 sm:p-4 md:p-6 bg-slate-50/50">
          <div className="space-y-6">
            <div>
